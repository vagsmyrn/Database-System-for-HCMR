...
mysqli_set_charset($con, "utf8");
  ...
  $sql="DELETE FROM species WHERE common = '$name'";

if (!mysqli_query($con,$sql))
{
die('3Error: ' . mysqli_error($con));
}else{
echo "<img src=\"img/tick.png\" width=\"25\" height=\"25\" /><strong>Species deleted succesfully</strong> <p> You are redirected to homepage... </p><p> <i>if you aren't redirected <a href=\"index.php\">click here</a></i></p>";

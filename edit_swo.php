...
<div id="wrapper">
    ...
    <div id="main"></div>
	 ...
	 if($privcheck == "admin" || $privcheck == "moderator" || $privcheck == "user" && $usercheck != "" && $usercheck != NULL) 
	  ...
	  ?></div>
        <div id="content">
    	          <h2>EDIT SWO measure SIZE DATA</h2>
                  
                  <?php
				  		$name = $_GET["swo"];
						$sql="SELECT * FROM SWOmeasure WHERE SWO_measure_ID = '$name'";
						$result = mysqli_query($con, $sql);
						$row = mysqli_fetch_array($result);
				  
				  ?>
                  
    	          <form action="change_swo.php" method="post" >
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  	<tr><th>Change the fields you want and press submit</th></tr>
                    <tr><td>SWO measure ID:</td>			<td><input type="text" name="SWO_measure_ID" value=" <?php echo $row['SWO_measure_ID'];?>"></td></tr>
                    <tr><td>Ljfl:</td> 	<td><input type="text" name="ljfl" value=" <?php echo $row['ljfl'];?>"></td></tr>
                    ...
                    <tr><td>Head length:</td> 	<td><input type="text" name="head_length" value=" <?php echo $row['head_length'];?>"></td></tr>
                    ...
                    <tr><td>Parasites:</td>		<td><input type="text" name="parasites" value=" <?php echo $row['parasites'];?>"></td></tr>

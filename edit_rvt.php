	 ...
	 if($privcheck == "admin" || $privcheck == "moderator" || $privcheck == "user" && $usercheck != "" && $usercheck != NULL) 
	  ...
	  ?></div>
        <div id="content">
                  ...
                  <?php
				  		$name = $_GET["rvt"];
						$sql="SELECT * FROM RVTmeasure WHERE RVT_measure_ID = '$name'";
						$result = mysqli_query($con, $sql);
						$row = mysqli_fetch_array($result);
				  
				  ?>
                  
    	          <form action="change_rvt.php" method="post" >
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  	<tr><th>Change the fields you want and press submit</th></tr>
                    <tr><td>RVT measure ID:</td>			<td><input type="text" name="BFT_measure_ID" value=" <?php echo $row['RVT_measure_ID'];?>"></td></tr>
                    ...
                    <tr><td>Pffl:</td> 	<td><input type="text" name="pffl" value=" <?php echo $row['pffl'];?>"></td></tr>

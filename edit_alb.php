...
<div id="wrapper">
    ...
    <div id="main"></div>
	 ...
	 if($privcheck == "admin" || $privcheck == "moderator" || $privcheck == "user" && $usercheck != "" && $usercheck != NULL) 
	  ...
	  ?></div>
        <div id="content">
    	          <h2>EDIT ALB measure SIZE DATA</h2>
                  
                  <?php
				  		$name = $_GET["alb"];
						$sql="SELECT * FROM ALBmeasure WHERE ALB_measure_ID = '$name'";
						$result = mysqli_query($con, $sql);
						$row = mysqli_fetch_array($result);
				  
				  ?>
                  
    	          <form action="change_alb.php" method="post" >
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  	<tr><th>Change the fields you want and press submit</th></tr>
                    <tr><td>ALB measure ID:</td>			<td><input type="text" name="ALB_measure_ID" value=" <?php echo $row['ALB_measure_ID'];?>"></td></tr>
